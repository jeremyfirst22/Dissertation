\chapter{Disagreement Between \pKa{} and Nitrile Vibrational Probes of Electrostatics: Experiments and Simulations in Staphylococcal Nuclease Demonstrate the Importance of Local interactions}\label{snase}
...
%
%Five pET42a plasmids containing the $\Delta+$PHS variant of SNase and a mutation, either V23C, L38C, T62C, V66C, or I92C, were generous gifts of Bertrand Garc\'ia-Moreno. 
...
A template SNase protein structure bound to \ce{Ca^2+} was modeled by homology from the pdb:3bdc crystal structure using the MODELLER software package \cite{Castaneda2009, Marti-Renom2000}. 
...
Each of the 10 protein systems was energy minimized in a vacuum using the steepest descent algorithm and then solvated in a dodecahedron box of TIP3P water, with a minimum distance of protein to the edge of the box of 1.5 nm \cite{Jorgensen1983}. 
...
The apparent lack of correlation between the \dpKa{} values reported by Garc\'ia-Moreno and coworkers and the nitrile frequencies in the same positions measured in this work (Figure \ref{fig:snase-pKas_vs_peak}), suggests that these two types of probes did not respond equally to the same interactions. 
